...
// Hybrid approach: Storing token in localStorage AND backend sets HTTP-only cookie
const TOKEN_KEY = '__app_auth_token__';
...
export const isAuthenticated = (): boolean => {
  if (typeof window === "undefined") {
    console.log("🔐 isAuthenticated: SSR context, returning false");
    return false;
  }
  ...
  try {
    ...
    if (result) {
      console.log("🔐 isAuthenticated: TRUE - Token found");
    } else {
